...
export const taContent: ClinicContent = {
  ...
  subtitle: "உயர்தர அசல் தூய ஹோமியோபதி மருத்துவம்",
  tagline: "42 வருட அனுபவமிக்க உயர்தர அசல் தூய ஹோமியோபதி சிகிச்சை",
  doctorName: "N. ஜெயகாந்தன்",
  experienceYears: 42,
  experienceBadge: "42 வருட சேவை அனுபவம்",
  ...
  nav: {
    ...
    getDirections: "வழி வரைபடம்"
  },

  hero: {
    badge: "42 ஆண்டுகள் நம்பிக்கையான பாரம்பரிய சிகிச்சை",
    title: "ஜெயகாந்தன் ஹோமியோபதி கிளினிக்",
    subtext: "42 வருட அனுபவமிக்க உயர்தர அசல் தூய ஹோமியோபதி சிகிச்சை. பெருந்துறையில் பல தலைமுறைகளாக தொடரும் நம்பிக்கை மருத்துவ சேவை.",
    callAction: "முன்பதிவு செய்ய அழைக்கவும்",
    directionsAction: "வழி வரைபடம் பெற",
    consultingTimeNotice: "பார்வை நேரம்: தினமும் காலை 10:00 மணி முதல் மாலை 05:00 மணி வரை"
  },
  ...
  infoCards: {
    ...
    appointmentText: "தயவுசெய்து ஒரு நாள் முன்னதாகவே தொலைபேசி மூலம் முன்பதிவு செய்யவும்.",
  ...
  specialitiesSection: {
    ...
    title: "சிகிச்சை அளிக்கப்படும் நோய்கள்",
    description: "நாள்பட்ட நோய்கள், சர்க்கரை நோய், ஒவ்வாமை, நரம்பு மற்றும் எலும்பு பிரச்சனைகளுக்கு 42 வருட அனுபவமிக்க ஹோமியோபதி தீர்வு.",
  ...
  contactSection: {
    ...
    getDirectionsBtn: "Google Maps வழி வரைபடம்",
    callBtn: "உடனே அழைக்க"
  },

  disclaimer: {
    title: "தகவல் அறிவிப்பு",
    text: "ஹோமியோபதி சிகிச்சைகள் நபருக்கு நபர் மாறுபடும். முறையான மருத்துவ ஆலோசனைக்கு N. ஜெயகாந்தன் அவர்களை நேரடியாக கிளினிக்கில் சந்திக்கவும்."
  },
