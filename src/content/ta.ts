...
export const taContent: ClinicContent = {
  ...
  hero: {
    badge: "42 வருட அனுபவம்",
    title: "அசல் தூய ஹோமியோபதி மருத்துவம்",
    subtext: "பெருந்துறையில் 42 ஆண்டுகளுக்கும் மேலாக பக்கவிளைவில்லாத அசல் ஹோமியோபதி மருத்துவ சிகிச்சை வழங்கப்படுகிறது.",
  ...
  specialitiesSection: {
    badge: "சிறப்பு சிகிச்சைகள்",
    title: "சிகிச்சை அளிக்கப்படும் முக்கிய நோய்கள்",
    description: "நாள்பட்ட நோய்கள், சர்க்கரை நோய், ஒவ்வாமை, நரம்பு, எலும்பு மற்றும் சருமப் பிரச்சனைகளுக்கு 42 வருட அனுபவமிக்க ஹோமியோபதி சிகிச்சை.",
